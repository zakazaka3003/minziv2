...
export function Footer() {
  return (
    <footer className="border-t border-[var(--border)]">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 py-10 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-8 items-start text-sm text-[var(--foreground-muted)]">
        <div>
